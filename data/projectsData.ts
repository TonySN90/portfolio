export const projectsData = [
  ...
  },
  {
    ...
    description:
      "Dieser Buchungskalender zeigt grafisch alle vergangenen, aktuellen und zukünftigen Buchungen innerhalb eines ausgewählten 3-Monats-Zeitraums an. Jede Buchung im Kalender bietet durch einen Klick direkten Zugang zu selbst programmierbaren Funktionen z.B Check-In, Check-Out, Detailsansicht oder Buchungs-Update. Dies ermöglicht es den Nutzern, den Kalender nach ihren eigenen Bedürfnissen anzupassen und eine effiziente Verwaltung sowie schnelle Bearbeitung der Buchungen direkt aus dem Kalender heraus vorzunehmen.",
    github: "https://github.com/TonySN90/react-booking-schedular",
    link: "https://react-booking-schedular.netlify.app",
    img: "RBS.webp",
  },
  {
    name: "Traveltrack",
